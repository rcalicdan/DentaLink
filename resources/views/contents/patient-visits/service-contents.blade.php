        ...
        <div class="p-5 space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
                ...
                <div class="md:col-span-7">
                    ...
                    <div class="relative">
                        <input type="text" wire:model.live="serviceSearch" placeholder="Search and select a service..."
                    ...
                    <div
                        ...
                        <button type="button" wire:click="selectService({{ $searchService->id }}, {{ $index }})"
                ...
                <div class="md:col-span-5 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Quantity
                            <span class="text-red-500">*</span></label>
                        <input type="number" wire:model.live="services.{{ $index }}.quantity" min="1"
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <p class="font-bold text-blue-800 dark:text-blue-300">
                                ₱{{ number_format((float) ($service['service_price'] ?? 0) * (int) ($service['quantity']
                                ?? 1), 2) }}
                            </p>
                        </div>
                    </div>
