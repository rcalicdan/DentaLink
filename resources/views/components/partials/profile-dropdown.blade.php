<div class="relative" x-data="{ open: false }" @click.outside="open = false">
    <button @click="open = !open"
        ...
        <div
            class="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center font-bold text-white shadow-md ring-2 ring-white/50 dark:ring-slate-400/50 text-sm">
            DQ
        </div>
        <span class="text-sm font-medium text-slate-700 dark:text-slate-300 hidden sm:inline">Dr. Quack</span>
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="p-4 border-b border-slate-200 dark:border-slate-700">
            <p class="font-semibold text-slate-800 dark:text-slate-200">Dr. Quack</p>
        ...
        <div class="py-1 border-t border-slate-200 dark:border-slate-700">
            <a href="#"
                class="flex items-center px-4 py-2 text-sm text-red-600 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10">
