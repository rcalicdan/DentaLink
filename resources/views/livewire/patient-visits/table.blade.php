<div>
    ...
    <div
        class="bg-gradient-to-r from-white to-slate-50 dark:from-slate-800 dark:to-slate-900 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 mb-8 overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
            <div class="flex items-center">
                ...
                <h3 class="text-xl font-semibold text-white">Filter Patient Visits</h3>
                <div class="ml-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="group">
                    <label class="flex items-center text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">
                        <div
                            class="bg-blue-100 dark:bg-blue-900/50 p-1.5 rounded-lg mr-2 group-hover:bg-blue-200 dark:group-hover:bg-blue-800/50 transition-colors">
                ...
                <div class="group">
                    <label class="flex items-center text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">
                        <div
                            class="bg-purple-100 dark:bg-purple-900/50 p-1.5 rounded-lg mr-2 group-hover:bg-purple-200 dark:group-hover:bg-purple-800/50 transition-colors">
                ...
                <div class="group">
                    <label class="flex items-center text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">
                        <div
                            class="bg-green-100 dark:bg-green-900/50 p-1.5 rounded-lg mr-2 group-hover:bg-green-200 dark:group-hover:bg-green-800/50 transition-colors">
                            <i class="fas fa-user text-green-600 dark:text-green-400 text-xs"></i>
                        </div>
                        Patient
                    </label>
                    <div class="relative">
                        <input type="text" wire:model.live="searchPatient" placeholder="Search patient name or ID..."
