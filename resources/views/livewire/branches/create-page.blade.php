<div class="container mx-auto px-2 py-0">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-800 dark:text-slate-200">Create New Branch</h1>
            <p class="text-slate-600 dark:text-slate-400 mt-1">Add a new branch to the system</p>
        </div>
    </div>
    ...
    <x-form.container title="Branch Information" subtitle="Fill in the details below to create a new branch"
        wire:submit="save">
        ...
        <div class="flex justify-end space-x-3 pt-6">
            ...
            <x-utils.submit-button buttonText="Create Branch" wireTarget="save" />
        </div>
    </x-form.container>
</div>