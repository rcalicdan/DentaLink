<div class="container mx-auto px-2 py-0">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-slate-800 dark:text-slate-200">Update Inventory Item</h1>
            <p class="text-slate-600 dark:text-slate-400 mt-1">Edit the details for: {{ $name }}</p>
        </div>
    </div>

    <x-form.container title="Item Information" subtitle="Modify the details below to update the inventory item"
        wire:submit="update">
        ...
        <div class="flex justify-end space-x-3 pt-6">
            ...
            <x-utils.submit-button buttonText="Update Item" wireTarget="update" />
        </div>
    </x-form.container>
</div>