<div class="min-h-screen bg-gray-50">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 text-lg">Patient ID: #{{ str_pad($patient->id, 6, '0', STR_PAD_LEFT) }}
                        </p>
                        <div class="flex items-center mt-2 space-x-4 text-blue-100">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('appointments.create') }}?patient_id={{ $patient->id }}"
                        class="inline-flex items-center px-4 py-2 border border-white border-opacity-30 rounded-lg shadow-sm text-sm font-medium text-white bg-white bg-opacity-20 hover:bg-opacity-30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white backdrop-blur-sm transition-all duration-200">
                    ...
                    <a href="{{ route('patients.index') }}"
                        class="inline-flex items-center px-4 py-2 border border-white border-opacity-30 rounded-lg shadow-sm text-sm font-medium text-white bg-white bg-opacity-10 hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white backdrop-blur-sm transition-all duration-200">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">{{ $patientStats['total_appointments'] }}
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-bold text-gray-900">{{ $patientStats['total_visits'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-rose-500 to-rose-600 rounded-xl flex items-center justify-center shadow-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        @if ($patientStats['next_appointment'])
            <div class="mb-8">
                <div
                    class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-400 p-6 rounded-r-xl shadow-sm">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-blue-900">Upcoming Appointment</h3>
            ...
            <div class="border-b border-gray-200 bg-white rounded-t-xl shadow-sm">
                <nav class="-mb-px flex space-x-8 px-6">
                    <button wire:click="setActiveTab('overview')"
                        class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200 {{ $activeTab === 'overview' ? 'border-blue-500 text-blue-600' : '' }}">
                        <div class="flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <button wire:click="setActiveTab('appointments')"
                        class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200 {{ $activeTab === 'appointments' ? 'border-blue-500 text-blue-600' : '' }}">
                        <div class="flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    ...
                    <button wire:click="setActiveTab('visits')"
                        class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200 {{ $activeTab === 'visits' ? 'border-blue-500 text-blue-600' : '' }}">
                        <div class="flex items-center">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        ...
                        <div class="bg-white shadow-xl rounded-2xl border border-gray-100 overflow-hidden">
                            <div class="bg-gradient-to-r from-gray-50 to-white px-8 py-6 border-b border-gray-100">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <h3 class="text-xl font-semibold text-gray-900">Patient Information</h3>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-white shadow-xl rounded-2xl border border-gray-100 overflow-hidden">
                            ...
                            <div class="p-6 space-y-3">
                                ...
                                <a href="{{ route('patients.edit', $patient) }}"
                                    class="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow hover:shadow-md">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex-shrink-0">
                                                        @if ($activity instanceof App\Models\Appointment)
                                                            <div
                                                                class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-100 to-blue-200 flex items-center justify-center">
                                                        ...
                                                        @else
                                                            <div
                                                                class="w-10 h-10 rounded-full bg-gradient-to-r from-green-100 to-green-200 flex items-center justify-center">
                ...
                <div class="bg-white shadow-xl rounded-2xl border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-b border-gray-100">
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900">Appointments History</h3>
                                <p class="text-gray-600 mt-1">Complete record of all scheduled appointments</p>
                            </div>
                            <a href="{{ route('appointments.create') }}?patient_id={{ $patient->id }}"
                    ...
                    <div class="overflow-x-auto">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($appointments as $appointment)
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                                ...
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 w-10 h-10">
                                                        <div
                                                            class="w-10 h-10 rounded-full bg-gradient-to-r from-blue-100 to-blue-200 flex items-center justify-center">
                                                            <span
                                                                class="text-sm font-semibold text-blue-700">#{{ $appointment->queue_number }}</span>
                                                        </div>
                                                    </div>
                                                    <div class="ml-4">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $appointment->status_badge }}">
                                                    <svg class="w-2 h-2 mr-1.5" fill="currentColor"
                                                        viewBox="0 0 8 8">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex items-center justify-end space-x-2">
                                                    <a href="{{ route('appointments.view', $appointment) }}"
                        ...
                        @else
                            <div class="px-6 py-12 text-center">
                                ...
                                <p class="mt-2 text-sm text-gray-500">This patient hasn't scheduled any appointments
                                    yet.</p>
                                <div class="mt-6">
                                    <a href="{{ route('appointments.create') }}?patient_id={{ $patient->id }}"
                                        class="inline-flex items-center px-4 py-2 border border-transparent rounded-xl text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-lg hover:shadow-xl transition-all duration-200">
            ...
            @if ($activeTab === 'visits')
                <div class="bg-white shadow-xl rounded-2xl border border-gray-100 overflow-hidden">
                    <div class="bg-gradient-to-r from-green-50 to-emerald-50 px-8 py-6 border-b border-gray-100">
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900">Visits History</h3>
                                <p class="text-gray-600 mt-1">Complete record of all patient visits and treatments</p>
                            </div>
                            <a href="{{ route('patient-visits.create') }}?patient_id={{ $patient->id }}"
                    ...
                    <div class="divide-y divide-gray-200">
                                ...
                                <div class="p-8 hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <div class="flex justify-between items-start mb-6">
                                        <div class="flex items-start space-x-4">
                                            <div class="flex-shrink-0">
                                                <div
                                                    class="w-12 h-12 bg-gradient-to-r from-green-100 to-emerald-200 rounded-xl flex items-center justify-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex justify-between items-start mb-2">
                                                            <div class="flex-1">
                                                                ...
                                                                <div
                                                                    class="flex items-center text-xs text-gray-600 space-x-2">
                                                                    <span
                        ...
                        @else
                            <div class="px-8 py-16 text-center">
                                <div
                                    class="mx-auto w-24 h-24 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full flex items-center justify-center mb-6">
                                ...
                                <p class="text-gray-500 mb-8 max-w-sm mx-auto">This patient hasn't had any visits yet.
